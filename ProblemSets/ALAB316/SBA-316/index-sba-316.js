let prePrompt = prompt("PRE-TEST: KNOWLEDGE SELF-CHECK: How confident are you in your knowledge of Box & Whisker Plots?  (On a scale with 1 being the least confident and 5 being the most confident)");
...
nameInput.title = 'Please type your full name with first name first and last name last.';
...
let postPrompt = prompt("POST-TEST: KNOWLEDGE SELF-CHECK: How confident are you in your knowledge of Box & Whisker Plots?  (On a scale with 1 being the least confident and 5 being the most confident)");
...
function task2HideSeek() {
  ...
  if (task2Box.style.display === "none") {
    ...
    btn2Task.style.fontStyle = "bold";
     btn2Task.style.textShadow = "2px 2px 4px #000000";
  } else {
    task2Box.style.display = "none";
    btn2Task.textContent = "Click for Task 2";
    btn2Task.style.fontFamily = "times";
...
btnPrint.setAttribute('onClick', 'window.location.assign("https://perscholas.com")');


/******* Text Content *********/
legend.innerHTML = `<i>Fill In Your Information</i>`;
title.textContent = "Box & Whisker Plots";
subtitle.textContent = "Box & Whisker Plots are a Graphical Representation of the Five-Number Summary.";
...
descript.textContent = "The three classes -- X, Y, & Z -- are all Psychology 101 classes taught by different teachers at the same school. The three box and whisker plots below represent the distribution of grades earned for each class of 30 students.";

quest1.textContent = "Based on the box plots, fill in the table with the requested information for each of the three classes.";
quest1.style.textAlign = "left";

quest2.textContent = "Based on three box and whisker plots above, explain which class provides the highest probability of receiving a high grade. Be Mindful: In your explanation, cite for each class a measure of center and a measure of spread and two class number grades that are most relevant to your answer.";
quest2.style.textAlign = "left";

endNote.textContent = "Before submitting your assignment for grading,bBe sure to check your work and print a copy for your records."
