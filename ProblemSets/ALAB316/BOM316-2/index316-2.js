...
/*** Select Random Pic ***/
/******** Knowledge Inspiration: Geeks for Geeks ********/
const picA = `${prefix}${imageARandom()}${suffix}`
const picB = `${prefix}${imageBRandom()}${suffix}`
picA.id = 'picA';
picB.id = 'picB';
